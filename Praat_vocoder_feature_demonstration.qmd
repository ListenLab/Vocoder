...
The sinewave carrier makes it easy to see the effects of the filtering. Unrelated fluctuations from other carriers (noise, harmonic complex) will be inherited into the output channel, making ti harder to cleanly see the effects of your envelope filtering.
...
## **Envelope / channel width interaction**
...
![Comparison of envelope compression in the full soundwave](https://raw.githubusercontent.com/ListenLab/Vocoder/main/images/envelope_compression_waveform.png){alt="Comparison of envelope compression in the full soundwave" width="408"}
